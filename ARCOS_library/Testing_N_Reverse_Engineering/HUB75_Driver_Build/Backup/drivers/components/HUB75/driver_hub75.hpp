...
public:
  ...
  /** Initialize the driver with injected hardware and buffer dependencies
   ...
   * @note Application must provide concrete implementations via dependency injection
   */
...
private:
  ...
  /** NOTE: Driver does NOT own injected dependencies
