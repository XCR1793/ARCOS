/*****************************************************************
 * File:      hal_logging_esp32dev.hpp
 * Category:  abstraction/platforms/esp32/wroom32s2/esp32dev
 * Author:    XCR1793 (Feather Forge)
 * 
 * Purpose:
 *    ESP32 Wroom32S2 (ESP32-Dev) platform implementation of the
 *    logging HAL.
 *    
...
#ifndef ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S2_ESP32DEV_HAL_LOGGING_ESP32DEV_HPP_
#define ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S2_ESP32DEV_HAL_LOGGING_ESP32DEV_HPP_
...
namespace arcos::abstraction{
  ...
  public:
    /**
     * @brief Initialize the ESP32 logging system.
     */
    static void Init(){
  ...
  using ESP32_Wroom32S2_LoggingDefault = logging::HalLogging<ESP32_Wroom32S2_Logging, 
                                                              logging::LogLevel::Info, 
                                                              logging::LogOutput::Serial>;

  // Debug build with verbose logging
  using ESP32_Wroom32S2_LoggingDebug = logging::HalLogging<ESP32_Wroom32S2_Logging, 
                                                            logging::LogLevel::Debug, 
                                                            logging::LogOutput::Serial>;

  // Verbose build with all logging
  using ESP32_Wroom32S2_LoggingVerbose = logging::HalLogging<ESP32_Wroom32S2_Logging, 
                                                              logging::LogLevel::Verbose, 
                                                              logging::LogOutput::Serial>;

  // Production build with errors only
  using ESP32_Wroom32S2_LoggingProduction = logging::HalLogging<ESP32_Wroom32S2_Logging, 
                                                                 logging::LogLevel::Error, 
                                                                 logging::LogOutput::Serial>;

} // namespace arcos::abstraction

#endif // ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S2_ESP32DEV_HAL_LOGGING_ESP32DEV_HPP_
