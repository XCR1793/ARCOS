/*****************************************************************
 * File:      hal_interface_i2c_module.hpp
 * Category:  abstraction/platforms/esp32/wroom32s3/module
 * Author:    XCR1793 (Feather Forge)
 * 
 * Purpose:
 *    ESP32-S3 module implementation of the standard I2C HAL interface.
 *    Provides direct implementation without requiring bridge
 *    patterns. Header-only implementation following ARCOS style.
 *****************************************************************/

#ifndef ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S3_MODULE_HAL_INTERFACE_I2C_MODULE_HPP_
#define ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S3_MODULE_HAL_INTERFACE_I2C_MODULE_HPP_
...
/** ESP32-S3 I2C HAL Implementation
 * 
...
struct ESP32S3_I2C_HAL{
  ...
  /** Initialize I2C bus with specified configuration */
...
#endif // ARCOS_ABSTRACTION_PLATFORMS_ESP32_WROOM32S3_MODULE_HAL_INTERFACE_I2C_MODULE_HPP_